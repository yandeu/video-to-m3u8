...
ffmpeg -i "./video/$thefile" \
  ...
  -filter:v:0 "fps=14.99, scale=480:270" -b:v:0 400k -maxrate:0 428k -bufsize:0 600k -b:a:0 64k \
  -filter:v:1 "fps=29.97, scale=640:360" -b:v:1 600k -maxrate:1 642k -bufsize:1 900k \
